---
layout:      default
title:       "@streetjs/plugin-sendgrid"
permalink:   /plugins/sendgrid/
nav_exclude: true
description:  "Official Street Framework plugin: SendGrid email. Official, signed, dependency-free StreetJS plugin — install from npm."
---

<script type="application/ld+json">
{"@context":"https://schema.org","@type":"SoftwareSourceCode","name":"@streetjs/plugin-sendgrid","description":"Official Street Framework plugin: SendGrid email.","codeRepository":"https://github.com/hassanmubiru/StreetJS","programmingLanguage":"TypeScript","runtimePlatform":"Node.js >= 22","softwareVersion":"1.0.2","license":"https://opensource.org/licenses/MIT","isPartOf":{"@type":"SoftwareApplication","name":"StreetJS","applicationCategory":"DeveloperApplication"}}
</script>
# @streetjs/plugin-sendgrid

**Official Street Framework plugin: SendGrid email.**
...
- **npm:** [@streetjs/plugin-sendgrid](https://www.npmjs.com/package/@streetjs/plugin-sendgrid)
- **Source:** [packages/plugin-sendgrid](https://github.com/hassanmubiru/StreetJS/tree/main/packages/plugin-sendgrid)
