---
layout:      default
title:       "@streetjs/plugin-redis"
permalink:   /plugins/redis/
nav_exclude: true
description:  "Official Street Framework plugin: Redis cache / key-value store (dependency-free RESP2 client). Official, signed, dependency-free StreetJS plugin — install from npm."
---

<script type="application/ld+json">
{"@context":"https://schema.org","@type":"SoftwareSourceCode","name":"@streetjs/plugin-redis","description":"Official Street Framework plugin: Redis cache / key-value store (dependency-free RESP2 client).","codeRepository":"https://github.com/hassanmubiru/StreetJS","programmingLanguage":"TypeScript","runtimePlatform":"Node.js >= 22","softwareVersion":"1.0.2","license":"https://opensource.org/licenses/MIT","isPartOf":{"@type":"SoftwareApplication","name":"StreetJS","applicationCategory":"DeveloperApplication"}}
</script>
# @streetjs/plugin-redis

**Official Street Framework plugin: Redis cache / key-value store (dependency-free RESP2 client).**

- **Category:** [Cache & KV](/StreetJS/plugins/category/cache-and-kv/)
- **Tier:** Official · **Signed** · **Dependency-free**
- **Version:** `v1.0.2`
- **Runtime dependencies:** none (third-party) — only `streetjs`
- **npm:** [@streetjs/plugin-redis](https://www.npmjs.com/package/@streetjs/plugin-redis)
- **Source:** [packages/plugin-redis](https://github.com/hassanmubiru/StreetJS/tree/main/packages/plugin-redis)
...
Browse the full [Plugin Marketplace](/StreetJS/plugins/marketplace/) or all [Cache & KV](/StreetJS/plugins/category/cache-and-kv/) plugins.
