---
layout:      default
title:       "@streetjs/plugin-clerk"
permalink:   /plugins/clerk/
nav_exclude: true
description:  "Official StreetJS plugin: Clerk identity backend API (dependency-free HTTPS client). Official, signed, dependency-free StreetJS plugin — install from npm."
---

<script type="application/ld+json">
{"@context":"https://schema.org","@type":"SoftwareSourceCode","name":"@streetjs/plugin-clerk","description":"Official StreetJS plugin: Clerk identity backend API (dependency-free HTTPS client).","codeRepository":"https://github.com/hassanmubiru/StreetJS","programmingLanguage":"TypeScript","runtimePlatform":"Node.js >= 22","softwareVersion":"1.0.2","license":"https://opensource.org/licenses/MIT","isPartOf":{"@type":"SoftwareApplication","name":"StreetJS","applicationCategory":"DeveloperApplication"}}
</script>
# @streetjs/plugin-clerk

**Official StreetJS plugin: Clerk identity backend API (dependency-free HTTPS client).**
