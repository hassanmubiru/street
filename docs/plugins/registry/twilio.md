---
layout:      default
title:       "@streetjs/plugin-twilio"
permalink:   /plugins/twilio/
nav_exclude: true
description:  "Official Street Framework plugin: Twilio SMS. Official, signed, dependency-free StreetJS plugin — install from npm."
---

<script type="application/ld+json">
{"@context":"https://schema.org","@type":"SoftwareSourceCode","name":"@streetjs/plugin-twilio","description":"Official Street Framework plugin: Twilio SMS.","codeRepository":"https://github.com/hassanmubiru/StreetJS","programmingLanguage":"TypeScript","runtimePlatform":"Node.js >= 22","softwareVersion":"1.0.2","license":"https://opensource.org/licenses/MIT","isPartOf":{"@type":"SoftwareApplication","name":"StreetJS","applicationCategory":"DeveloperApplication"}}
</script>
...
- **npm:** [@streetjs/plugin-twilio](https://www.npmjs.com/package/@streetjs/plugin-twilio)
- **Source:** [packages/plugin-twilio](https://github.com/hassanmubiru/StreetJS/tree/main/packages/plugin-twilio)
