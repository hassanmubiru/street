---
layout:      default
title:       "@streetjs/plugin-postgres"
permalink:   /plugins/postgres/
nav_exclude: true
description:  "Official StreetJS plugin: PostgreSQL connection pool (wraps the native, dependency-free core driver). Official, signed, dependency-free StreetJS plugin — install from npm."
---

<script type="application/ld+json">
{"@context":"https://schema.org","@type":"SoftwareSourceCode","name":"@streetjs/plugin-postgres","description":"Official StreetJS plugin: PostgreSQL connection pool (wraps the native, dependency-free core driver).","codeRepository":"https://github.com/hassanmubiru/StreetJS","programmingLanguage":"TypeScript","runtimePlatform":"Node.js >= 22","softwareVersion":"1.0.2","license":"https://opensource.org/licenses/MIT","isPartOf":{"@type":"SoftwareApplication","name":"StreetJS","applicationCategory":"DeveloperApplication"}}
</script>
# @streetjs/plugin-postgres

**Official StreetJS plugin: PostgreSQL connection pool (wraps the native, dependency-free core driver).**
...
- **npm:** [@streetjs/plugin-postgres](https://www.npmjs.com/package/@streetjs/plugin-postgres)
- **Source:** [packages/plugin-postgres](https://github.com/hassanmubiru/StreetJS/tree/main/packages/plugin-postgres)
