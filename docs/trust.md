...
| **CycloneDX SBOM** | A per-release software bill of materials is generated and uploaded | [Security guide](/StreetJS/security/) |
...
- **Threat model** — documented attacker model and mitigations (see the Security guide)
