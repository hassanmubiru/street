...
street create my-app --starter saas        # SaaS overlay (multi-tenant orgs, RBAC, billing, audit log)
...
street create my-saas --starter saas --with-billing --with-admin-ui  # SaaS opt-in modules
```
