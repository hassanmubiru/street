...
| **StreetJS** | **29,111** | **28,933** | **29,753** | **28,646** | **2** | **3** | **4** | **70** |
...
| **StreetJS** | **27,537** | **27,700** | **28,193** | **26,717** |
| Express | 13,034 | 13,017 | 13,217 | 12,867 |
| NestJS | 11,741 | 11,783 | 11,787 | 11,652 |

## Summary

- **StreetJS sustains ~27–29k req/s** with P99 ≤ 4ms on this host.
...
- Ordering is stable across runs (Fastify ≳ Hono ≳ StreetJS ≫ Express ≳ NestJS).
