...
- [x] 3. Lazy database initialization (foundational for cloud bootstrap)
  ...
  - [x] 3.3 Write integration test for no-DB bootstrap
...
- [ ] 4. Cloud Deployment Verification
  ...
  - [x] 4.3 Implement remaining target assets and adapters
  ...
  - [x] 4.4 Implement per-target deploy/smoke/report scripts and the report builder
...
- [x] 7. Network Plugin Registry
  ...
  - [x] 7.3 Write property test for signature verification soundness
...
- [x] 9. Official Plugin Ecosystem
  ...
  - [x] 9.3 Implement install-through-registry with enforced signature verification
...
- [x] 10. Enterprise Console APIs
  ...
  - [x] 10.2 Write property test for authentication/authorization gating
...
- [x] 12. Interactive Developer Experience
  ...
  - [x] 12.3 Write property test for the dependency graph
...
- [ ] 13. Upgrade System and codemods
  ...
  - [x] 13.7 Wire `street upgrade` reporting and the codemod test artifact + CI
...
- [x] 15. Kafka Coordinator Readiness Gate and Chaos
  ...
  - [x] 15.3 Implement the chaos framework scenarios and lost-message accounting
...
- [x] 16. Advanced Observability
  ...
  - [x] 16.4 Implement the dashboards, alerts, and SLO pack
