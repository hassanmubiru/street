...
export class MessageService {
  ...
  private readonly moderation: ModerationToolkit;
   ...
   */
  async send(from: string, to: string, body: string): Promise<SendResult> {
    ...
    const blocked =
      !(await this.moderation.canMessage(fromId, toId)) ||
