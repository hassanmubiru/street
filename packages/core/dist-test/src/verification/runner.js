...
export class CommandRunner {
    async run(opts) {
        ...
        const blockedReason = outcome.timedOut
        ...
        const passingTests = hints.passingTests ??
        ...
        try {
            ...
            throw new Error(`Failed to write Verification Artifact for capability '${opts.capabilityId}' to '${outPath}': ${cause}`, { cause: err });
        }
     ...
     */
    static async writeArtifactAtomic(path, a) {
     ...
     */
    spawnWithTimeout(opts, timeoutMs) {
