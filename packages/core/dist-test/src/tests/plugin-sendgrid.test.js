...
import { PluginHost, signManifest, PluginPermissionError, PluginError, } from '../platform/plugins/host.js';
import { SendGridPlugin, SendGridClient, sendGridPluginManifest, validateSendGridConfig, SENDGRID_PLUGIN_NAME, } from '../platform/plugins/official/sendgrid.js';
...
describe('SendGrid plugin — install through PluginHost', () => {
    it('registers (signed), enforces permissions, enables, and injects the client', async () => {
        ...
        assert.ok(ctx.state['mail'] instanceof SendGridClient);
    });
...
//# sourceMappingURL=plugin-sendgrid.test.js.map