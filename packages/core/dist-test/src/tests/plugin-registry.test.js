...
import { PluginHost, signManifest, PluginSignatureError, PluginError, PluginStateError, } from '../platform/plugins/host.js';
...
describe('plugin registry — signature enforcement', () => {
    it('refuses to publish an unsigned manifest', () => {
        ...
        const reg = new LocalPluginRegistry();
        const unsigned = s3PluginManifest(); // no checksum/signature
