...
export async function measureStreetStartup() {
...
export async function runHttpBenchmark(label, port, durationMs = 5000, concurrency = 10, path = '/bench') {
...
void Router;
void createServer;
//# sourceMappingURL=http-benchmark.js.map